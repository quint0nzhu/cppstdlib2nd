...
#include <deque>
#include <set>
#include <iterator> //for ostream_iterator<> and instream_iterator<>
...
int main()
{
  ...
  *intWriter=-5;
  ...
  //create inserter for coll11
  //-inconvenient way
  asso_insert_iterator<decltype(coll11)> iter3(coll11);
  ...
  *iter3=3;
  ...
  std::for_each(coll11.cbegin(),coll11.cend(),[](const decltype(*coll11.cbegin())& elem){
      std::cout<<elem<<' ';
    });
  std::cout<<std::endl;

  //create inserter for coll11 and insert elements
  //-convenient way
  asso_inserter(coll11)=44;
  asso_inserter(coll11)=55;
  ...
  copy(vals.begin(),vals.end(),//source
       asso_inserter(coll11));//destination
