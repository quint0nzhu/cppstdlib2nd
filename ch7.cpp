...
int main()
{
  ...
  std::set<std::string> coll37((std::istream_iterator<std::string>(std::cin)),
                               (std::istream_iterator<std::string>()));

  //print all elements

  copy(coll37.cbegin(),coll37.cend(),
       std::ostream_iterator<std::string>(std::cout,"\n"));

  //create a string vector
  //- initialized by all words from standard input
  std::vector<std::string> coll38((std::istream_iterator<std::string>(std::cin)),
                                  (std::istream_iterator<std::string>()));

  //sort elements
  sort(coll38.begin(),coll38.end());

  //print all elements ignoring subsequent duplicates
  unique_copy(coll38.cbegin(),coll38.cend(),
              std::ostream_iterator<std::string>(std::cout,"\n"));
